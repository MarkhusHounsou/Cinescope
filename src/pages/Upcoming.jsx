...
const Upcoming = () => {
  ...
  const endpoint = hasActiveFilters ? '/discover/movie' : '/movie/upcoming';
  ...
  if (page > 1 && JSON.stringify(apiParams) !== sessionStorage.getItem('lastParamsUpcoming')) {
    setPage(1);
  }
  sessionStorage.setItem('lastParamsUpcoming', JSON.stringify(apiParams));
